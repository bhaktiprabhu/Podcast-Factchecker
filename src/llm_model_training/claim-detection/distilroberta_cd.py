"""Training of DistilRoBERTa Transformer model with Podcast Claim Detection Dataset"""
...
model_path = os.path.join(current_dir, "saved-models", "distilroberta-podcast-claim-detection")
