...
auto_model = AutoModelForSequenceClassification.from_pretrained("albert-base-v2", num_labels=2)

print("------------------------------------------------------------------------------------------")
print(
    f"Pre-Trained Model 'albert-base-v2' has been Loaded: \
...
model_path = os.path.join(current_dir, "saved-models", "albert-sd-custom")
